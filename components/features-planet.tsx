        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              PreOffer строит понятную карту подготовки под вашу роль
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Собираем реальные вопросы по каждой профессии и грейду и сразу
                показываем, что спрашивают чаще всего именно сейчас.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Частота по компаниям</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Видите статистику по компаниям и типам вакансий, чтобы точнее
                настроить подготовку под конкретное интервью.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Прокачка основ</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Подсказки по темам и паттернам, которые дают максимум эффекта:
                что повторить сейчас, а что можно отложить.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Симуляции с AI</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Тренируйтесь на реальных сценариях: AI-интервьюер задаёт
                вопросы, фиксирует ответы и подсказывает, где усилить аргументацию.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Краткие ответы</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Каждый вопрос сопровождаем кратким ответом, разбором и ссылками
                на ресурсы, чтобы освежить знания за минуты.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Сохранённые заметки</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Добавляйте свои шпаргалки и ссылки к каждому вопросу и
                возвращайтесь к ним, когда нужно повторить перед интервью.
              </p>
            </article>
          </div>
        </div>
