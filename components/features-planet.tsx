        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              PreOffer показывает, что реально спрашивают на junior-собеседованиях
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Реальные вопросы</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Собираем вопросы и задачи из интервью по направлениям и
                компаниям, чтобы ты видел актуальные формулировки.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Что проверяют</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                У каждого вопроса объясняем, какую компетенцию ждут и зачем
                его задают.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Норма vs провал</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Показываем, какой ответ считается нормой, а какой — сигналом
                для отказа, с короткими подсказками.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Подсвечиваем частые провалы в логике, терминах и примерах —
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Фильтры по стеку</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Подборки по стеку, теме и типу роли помогают учить именно то,
                что спросят в твоём направлении.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Получаешь понятный маршрут: что закрыть сейчас, что повторить
                позже и когда возвращаться к пробелам.
              </p>
            </article>
          </div>
        </div>
