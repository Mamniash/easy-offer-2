        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              PreOffer показывает, где ты теряешь оффер — и что делать дальше
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Собираем реальные вопросы с собесов и показываем, что спрашивают
                чаще всего по роли и уровню Junior.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Критичные вопросы для оффера</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Помечаем вопросы, которые чаще всего “режут” кандидата.
                Готовишься не к случайному, а к решающему.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
            ...
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Карта подготовки вместо “учи всё”</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Только нужное: что закрыть сегодня, что оставить на потом, где у
                тебя пробел.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Прогон как на реальном собесе</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Режим “10–15 вопросов подряд” — чтобы понять, где ты плывёшь, до
                интервью, а не после отказа.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Трекер по темам: видишь, что уже закрыто и что осталось до
                уверенного техэтапа.
              </p>
            </article>
          </div>
