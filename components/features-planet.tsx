        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              PreOffer раскрывает, что реально спрашивают на Junior-собесах
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>База реальных вопросов</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Собираем вопросы и задачи с интервью по направлениям
                (Frontend, Backend, QA, Data) и уровню Junior.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Зачем спрашивают</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                У каждого вопроса есть пояснение: какую компетенцию проверяют
                и что хотят услышать интервьюеры.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Нормальный ответ vs провал</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Показываем границы: что считается нормальным ответом и где
                начинается провал на собеседовании.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Типовые ошибки junior’ов</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Разбираем, какие формулировки режут кандидатов и как их
                исправить, чтобы не терять баллы.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Фильтры по стеку и темам</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Быстрые подборки под конкретный стек, темы и типы задач —
                чтобы готовиться ровно под свои собеседования.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Подборки по компаниям</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Сравниваем форматы интервью и ожидания, чтобы заранее понять,
                где будут акценты и как подготовиться.
              </p>
            </article>
          </div>
        </div>
