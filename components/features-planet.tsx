        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              PreOffer подсказывает, какие темы дадут максимум шансов на оффер
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Живой индекс вопросов</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Сводим реальные вопросы и задачи, которые задают сегодня.
                Частота обновляется по профессии, грейду и компании.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Видишь приоритеты на одной карте: что выучить сейчас, что
                повторить позже, где пробелы по ключевым темам.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Каждый вопрос сопровождаем чек-листом, примерами и короткими
                подсказками, чтобы отвечать уверенно, а не наугад.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                <svg
                  ...
                  height={16}
                >
                  <path d="M3 2a1 1 0 0 0-1 1v7.472a2 2 0 0 0 .93 1.683l5.5 3.667a1 1 0 0 0 1.14 0l5.5-3.667A2 2 0 0 0 16 10.472V3a1 1 0 1 0-2 0v7.472a.001.001 0 0 1 0 .001l-5 3.333-5-3.334V3a1 1 0 0 0-1-1Z" />
                  <path d="M5 1a1 1 0 0 0-1 1v7.5a1 1 0 1 0 2 0V7h4a3 3 0 0 0 0-6H5Zm0 4V3h4a1 1 0 1 1 0 2H5Z" />
                </svg>
                <span>Практика с карьерным экспертом</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Живые разборы с ментором под вашу роль: уточняем контекст,
                тренируем ответы и даём персональную обратную связь.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Локальные требования</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Учитываем стек, рынок и город: разные акценты для
                разработчиков, тестировщиков, аналитиков и менеджеров.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Видно прогресс</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Отслеживайте, как закрываются темы, и сколько осталось до
                готовности к следующему раунду.
              </p>
            </article>
          </div>
        </div>
