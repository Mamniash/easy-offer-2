          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-lg text-gray-700">
                Нажмите на профессию — увидите частые вопросы, подсказки и
                фильтры по грейду. Карточки ниже — готовые подборки тем: их
                можно двигать и дополнять под задачи вашей команды.
              </p>
            </div>
