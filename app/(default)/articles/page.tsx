      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white/90 p-10 shadow-xl backdrop-blur">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex gap-6 rounded-2xl bg-gray-900/95 p-6 text-gray-100 shadow-lg">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-4xl font-semibold">
                  {displayTags.length.toLocaleString("ru-RU")}
                </p>
              </div>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    <div className="relative h-44 w-full overflow-hidden bg-gray-100">
                      ...
                      {article.tags ? (
                        <span className="absolute left-3 top-3 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-gray-700 shadow">
                          {article.tags}
                        </span>
                      ) : null}
                    </div>
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      <div className="mt-4 flex items-center justify-between text-xs text-gray-500">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-1 font-semibold text-sky-600 transition group-hover:text-sky-500"
                        >
                          Читать статью
