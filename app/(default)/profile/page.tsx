    ...
    <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-600 to-blue-500 p-5 text-white shadow-sm shadow-black/[0.08]">
            <h2 className="text-sm font-semibold uppercase tracking-wide text-blue-100">
              PRO-подписка
            </h2>
            <p className="mt-2 text-sm text-blue-50">
              Открой полный доступ к вопросам, источникам и новым материалам.
              Сравни возможности и выбери подходящий тариф.
            </p>
            <Link
              href="/pro"
              className="mt-4 inline-flex items-center justify-center rounded-full bg-white px-4 py-2 text-xs font-semibold text-blue-700 shadow-sm transition hover:bg-blue-50"
            >
              Перейти к PRO
            </Link>
          </div>
